...
export const recentActivity = [
  { date: "12 Aug 2026", company: "ABC Logistics", ref: "INV-20391", type: "Sent", amount: "-$2,500.00 USD", status: "Completed" },
  { date: "11 Aug 2026", company: "Global Freight Ltd", ref: "INV-8842", type: "Received", amount: "+$4,200.00 USD", status: "Completed" },
  { date: "09 Aug 2026", company: "XYZ Cargo", ref: "INV-7712", type: "Sent", amount: "-€850.00 EUR", status: "Processing" },
  { date: "07 Aug 2026", company: "WSA Pay Deposit", ref: "DEP-10291", type: "Deposit", amount: "+$5,000.00 USD", status: "Completed" },
  { date: "06 Aug 2026", company: "Oceanic Logistics", ref: "INV-5512", type: "Received", amount: "+$1,750.00 USD", status: "Completed" },
];

export const partnersDirectory = [
  { name: "EUGENE' Logistics Co., Ltd", city: "Qingdao", country: "China", id: "98551" },
  { name: "'K' Line Logistics (Hong Kong) Ltd", city: "Hong Kong", country: "Hong Kong", id: "65362" },
  ...
  { name: "+Carga - Transitos Comercio e Servicos Lda", city: "Lisbon", country: "Portugal", id: "55680" },
  { name: "1 2 3 Air Sea Rail International Transport GmbH", city: "Hamburg", country: "Germany", id: "71708" },
  { name: "101 Supply Chain Group (Los Angeles, CA, US)", city: "Los Angeles", country: "United States", id: "145512" },
];
...
export const selectedPayees = [
  ...
  { name: "Alpha Cargo International Logistics S.A.S.", city: "Paris", country: "France", id: "152285" },
  { name: "Americargo Logistics (DRV Forwarding SA DE CV)", city: "Jalisco", country: "Mexico", id: "75967" },
  { name: "AOF CARGO LOGISTICS CO., LTD (Taipei, TW)", city: "Taipei", country: "Taiwan", id: "54933" },
  { name: "APEX International Inc (Tokyo, JP)", city: "Tokyo", country: "Japan", id: "35908" },
];

export const companyUsers = [
  { initials: "RS", name: "Remon Saerosem", email: "remon@pfsegypt.com", role: "Administrator", last: "12 Aug 2026 11:57 AM", you: true },
  { initials: "MA", name: "Mariam Adel", email: "mariam@pfsegypt.com", role: "Finance Manager", last: "11 Aug 2026 09:21 AM", you: false },
  { initials: "KA", name: "Karim Ahmed", email: "karim@pfsegypt.com", role: "Finance Officer", last: "10 Aug 2026 04:35 PM", you: false },
  { initials: "HA", name: "Hoda Ali", email: "hoda@pfsegypt.com", role: "Viewer", last: "08 Aug 2026 02:11 PM", you: false },
];
